module.exports = {
  ...
  refreshStationMviews: 'REFRESH MATERIALIZED VIEW u_flood.telemetry_context_mview with data; REFRESH MATERIALIZED VIEW u_flood.station_split_mview with data;'
}
